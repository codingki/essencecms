			...
			<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
				...
				<li class="m-nav__item">
					<a href="" class="m-nav__link">
						<span class="m-nav__link-text">Edit Portofolio</span>
					</a>
				</li>
...
{!! Form::model($porto, ['method'=> 'PATCH', 'action' => ['PortofolioController@update', $porto->id], 'files'=>true]) !!}
<div class="row">
	...
	<div class="col-md-3">
    	...
    	<div class="slim"
	        ...
	        <img src="{{URL::asset($porto->thumbnail_image->file)}}" >
	    </div>
	</div>
	...
	<div class="col-md-12">
		...
		<div class="form-group">
			...
			<div class="slim"
		         data-label="Drop Photo here"
		         data-save-initial-image=true
		         >
		         
		        <input type="file" name="slim[]" value="{{ url(App\Photo::findOrFail($a)->file)  }}"/>
		        	<img src="{{ url(App\Photo::findOrFail($a)->file ) }}">
			</div>
		    @endforeach
		</div>
	</div>
